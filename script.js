let musics = [
    ...
    {
        name : "I'm Alive",
        cover : "imgs/im_alive.jpg",
        Audio : new Audio("./musics/im_alive.mp3")
    },

    {
        name : "Dj Valka - Faded",
        cover : "imgs/Dj-valka-faded.jpg",
        Audio : new Audio("./musics/Dj-valka-faded.mp3")
    }
]

let range = document.querySelector("#music-item")
